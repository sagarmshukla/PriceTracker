...
<div class="signin-container">
    ...
    <div class="signin-form">
        ...
        <!-- Form -->
        <form action="{{route('post:login')}}" id="signin-form_id" method="post">
            @if ($errors->has())
            ...
            @if(Session::has('email-success'))
                <p class="alert alert-success">{{Session::get('email-success')}}</p>
            @endif
            @if(Session::has('password-change'))
                <p class="alert alert-success">{{Session::get('password-change')}}</p>
            @endif
        ...
        <div class="signin-with">
            <!-- Facebook -->
            <a href="{{route('social', 'facebook')}}" class="signin-with-btn" style="background:#4f6faa;background:rgba(79, 111, 170, .8);">Sign In with <span>Facebook</span></a>
        </div>
        <!-- / "Sign In with" block -->
